...
dependencies {
    ...
    // Material 3 Expressive + compatible compose libs (all pinned to 1.12.0-beta02)
    implementation("androidx.compose.runtime:runtime:1.12.0-beta02")
    implementation("androidx.compose.ui:ui:1.12.0-beta02")
    implementation("androidx.compose.ui:ui-graphics:1.12.0-beta02")
    implementation("androidx.compose.ui:ui-tooling-preview:1.12.0-beta02")
    debugImplementation("androidx.compose.ui:ui-tooling:1.12.0-beta02")
    implementation("androidx.compose.material3:material3:1.5.0-alpha23")
    implementation("androidx.compose.foundation:foundation:1.12.0-beta02")
    implementation("androidx.compose.animation:animation:1.12.0-beta02")
    ...
    implementation("androidx.palette:palette-ktx:1.1.0-alpha01")
    ...
    implementation("androidx.media3:media3-session:1.11.0-beta01")
    ...
    testImplementation("androidx.compose.ui:ui-test-junit4:1.12.0-beta02")
