...
class SettingsDataStoreTest {
    ...
    @Test fun `boolean toggles roundtrip`() = runTest {
        ...
        store.setWavyProgressBar(false); assertThat(store.wavyProgressBar.first()).isFalse()
        ...
        store.setSpotifyEnabled(true); assertThat(store.spotifyEnabled.first()).isTrue()
        ...
        store.setSpotifyConnected(true); assertThat(store.spotifyConnected.first()).isTrue()
