...
open class AppUpdateService @Inject constructor(
     ...
     */
    // The Int-flags overload is deprecated on API 33+ but is the only one that
    // exists down to this branch's minSdk (26); the ResolveInfoFlags overload
    // is API 33-only and crashes on Android 8-12.
