...
object FolderIo {
    ...
    suspend fun <T> readJson(context: Context, treeUri: Uri, name: String, serializer: KSerializer<T>): T? = withContext(Dispatchers.IO) {
    ...
    suspend fun <T> writeJson(context: Context, treeUri: Uri, name: String, serializer: KSerializer<T>, value: T) =
