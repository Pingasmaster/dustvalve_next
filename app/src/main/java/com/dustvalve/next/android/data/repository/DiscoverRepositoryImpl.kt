...
@Singleton
class DiscoverRepositoryImpl @Inject constructor(private val discoverScraper: DustvalveDiscoverScraper) : DiscoverRepository {

    override suspend fun discover(genre: String?, cursor: String?): DiscoverResult =
        discoverScraper.discover(genre = genre, cursor = cursor)
}
