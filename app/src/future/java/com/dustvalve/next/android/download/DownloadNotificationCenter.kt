 ...
 *
 * Future flavor (api=future, minSdk 37 / Android 17): Live Update-only path.
 * The flavor's minSdk satisfies the Live Update APIs' formal API 36.1 (QPR1)
 * requirement, so no lint suppression or runtime gating is needed here.
 * The compat flavor ships a dual-pipeline variant
 * (Live Update when capable + NotificationCompat fallback).
 *
