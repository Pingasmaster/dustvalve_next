 ...
 * and writes a single-line CSV under filesDir/metrics/. Future flavor
 * (minSdk=37) always has the API; compat ships a no-op stub because
 * ApplicationStartInfo must not be referenced at class-load on minSdk 26.
 *
