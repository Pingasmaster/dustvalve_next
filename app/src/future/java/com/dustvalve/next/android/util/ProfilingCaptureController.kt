 ...
 *
 * minSdk=37 on the future flavor so the ProfilingManager + ProfilingTrigger +
 * ANOMALY trigger API surface is always available. Compat ships a no-op stub
 * (those types must not be referenced at class-load on minSdk 26).
 */
@Singleton
