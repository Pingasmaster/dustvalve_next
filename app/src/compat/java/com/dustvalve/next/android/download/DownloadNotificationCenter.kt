 ...
 *
 * Compat flavor (api=compat, minSdk 26 / Android 8-16). Two rendering
 * pipelines, selected once via [liveUpdateCapable]:
 ...
 * - Everything below: a classic NotificationCompat determinate-progress
 *   card. This path MUST exist - ProgressStyle is an API 36 class and the
 *   promoted-ongoing setters are API 36.1, and calling them below that
 *   crashed every download in v0.5.0-v0.5.2 (NoClassDefFoundError inside
 *   DownloadService's startForeground).
 *
